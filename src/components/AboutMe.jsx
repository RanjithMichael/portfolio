...
const AboutMe = () => {
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center bg-white rounded-xl shadow-lg p-10 animate-fadeIn">
        ...
        <div className="text-center md:text-left">
          ...
          {/* Description */}
          <p
            className="text-lg text-gray-700 leading-relaxed mb-6 animate-fadeIn delay-200"
          ...
          <section aria-label="Key strengths">
            <ul className="text-gray-700 mb-8 list-disc list-inside space-y-2 animate-fadeIn delay-300">
          ...
          <div className="flex justify-center md:justify-start gap-6 flex-wrap animate-slideUp delay-400">
            <a
