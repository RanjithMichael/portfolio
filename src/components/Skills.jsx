...
import { FaReact, FaNodeJs, FaGithub, FaLock, FaShieldAlt, FaCogs } from "react-icons/fa";
...
<div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1">
  ...
  <ul className="grid grid-cols-2 gap-4 text-gray-700">
    <li className="flex items-center gap-2 hover:text-indigo-600 transition">🧩 Problem Solving</li>
    <li className="flex items-center gap-2 hover:text-pink-600 transition">👥 Team Collaboration</li>
    <li className="flex items-center gap-2 hover:text-blue-600 transition">🗣️ Communication</li>
    <li className="flex items-center gap-2 hover:text-green-600 transition">🎯 Time Management</li>
    <li className="flex items-center gap-2 hover:text-yellow-600 transition">🔄 Adaptability</li>
    <li className="flex items-center gap-2 hover:text-purple-600 transition">💡 Critical Thinking</li>
    <li className="flex items-center gap-2 hover:text-red-600 transition">🤔 Decision Making</li>
    <li className="flex items-center gap-2 hover:text-teal-600 transition">📚 Continuous Learning</li>
    <li className="flex items-center gap-2 hover:text-orange-600 transition">🧑‍🏫 Leadership</li>
    <li className="flex items-center gap-2 hover:text-gray-600 transition">🤝 Conflict Resolution</li>
  </ul>
</div>
